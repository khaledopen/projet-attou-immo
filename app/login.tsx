...
const styles = StyleSheet.create({
  ...
  logoContainer: { width: 80, height: 80, backgroundColor: '#eff6ff', borderRadius: 28, justifyContent: 'center', alignItems: 'center', marginBottom: 20 },
  ...
  loginButton: { backgroundColor: '#1e3a8a', paddingVertical: 20, borderRadius: 18, alignItems: 'center', shadowColor: '#1e3a8a', shadowOpacity: 0.3, shadowRadius: 15, elevation: 8 },
  loginButtonText: { color: '#fff', fontSize: 18, fontWeight: 'bold' },
  footer: { flexDirection: 'row', justifyContent: 'center', marginTop: 35 },
  footerText: { color: '#64748b', fontSize: 15 },
  registerLink: { color: '#1e3a8a', fontWeight: '800', fontSize: 15 }
});
